...
<form method="post" name='f'>
	<div class='wrap'>
		<div class='wrapbox'>
			...
			String strSQL = "Select id,email From test_nsz.tb_user where id='"+userID+"';";
			...
			<div class='login'>
				...
				<div class='loginbox'>
					<input type='button' class='loginbutton' value='정보 변경' onclick='goUserInfoUpdate();' />
				</div>
				<div class='loginbox'>
					<div class='joinbox'>
					<input type='hidden' name='inData' />
					<input type='button' class='joininput' value='탈퇴하기' onclick="goUserInfoDelete('<%=userID%>');" />
					</div>
				</div>
			</div>
			<%
